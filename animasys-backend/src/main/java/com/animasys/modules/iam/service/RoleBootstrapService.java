...
public class RoleBootstrapService {
    ...
    private static final List<SystemRoleDef> SYSTEM_ROLES = List.of(
            new SystemRoleDef("OWNER", "Owner", "Full system access", PermissionScope.ALL),
            new SystemRoleDef("MANAGER", "Manager", "Management and operations", PermissionScope.ALL_EXCEPT_FACTORY_RESET),
            new SystemRoleDef("CASHIER", "Cashier", "Point of sale operations", PermissionScope.CASHIER),
            new SystemRoleDef("GROOMER", "Groomer", "Grooming and pet services", PermissionScope.GROOMER)
    );
